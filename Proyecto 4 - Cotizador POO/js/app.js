//Variables
function Registro(marca, anio, seguro) {
    this.marca = marca;
    this.anio = anio;
    this.seguro = seguro;
}

Registro.prototype.cotizar = function () {
    let cantidad;
    const base = 2000;
    switch (this.marca) {
        case 'Americano':
...
Interfaz.prototype.mostrarEstado = function (info, tipo) {
...
Interfaz.prototype.mostrarResultado = function (dato, info) {
